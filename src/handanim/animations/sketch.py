...
from handanim.core.styles import FillStyle
from handanim.primitives.ellipse import GlowDot
...
class SketchAnimation(AnimationEvent):
    ...
    def __init__(self, start_time=0.0, duration=0.0, easing_fun=None, data=None) -> None:
