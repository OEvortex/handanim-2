...
from handanim.primitives import Arrow, Circle, Eraser, Line, Text
...
scene.add(SketchAnimation(start_time=31.5, duration=1), drawable=arrow_to_solar)
scene.add(FadeInAnimation(start_time=32, duration=1), drawable=final_msg)
